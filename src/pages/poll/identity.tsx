...
export default function IdentitiesPage() {
    ...
    console.log("the string is .....", _identity)
    ...
    useEffect(() => {
        ...
        console.log("the string is .....",identityString)
    ...
    const createIdentity = useCallback(async () => {
        ...
        console.log("ssfasdfasdfasdfasdfsd", identity)
    ...
    return (
        <>
            ...
            <Stepper step={1} onNextClick={_identity && (() => router.push("/poll/groups"))} />
        </>
    )
}
